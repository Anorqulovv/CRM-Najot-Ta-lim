  ...
  return (
    <div style={{ padding: '24px 24px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 22 }}>
        ...
        <div>
          <h1 style={{ margin: 0, fontSize: 19, fontWeight: 700, color: '#ffffff' }}>O'quvchilar va ota-onalar</h1>
          <span style={{ color: 'rgba(255,255,255,0.78)', fontSize: 12 }}>Barcha o'quvchilar va ularning ota-onalari</span>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 14, marginBottom: 22, flexWrap: 'wrap' }}>
        {[
          ...
          { label: "Ota-ona biriktirilmagan", value: withoutParent, color: '#dc2626', bg: '#fef2f2', border: '#fecaca' },
        ].map((stat) => (
      ...
      <div style={{ marginBottom: 18 }}>
        <Input
          size="large"
          prefix={<SearchOutlined style={{ color: 'rgba(255,255,255,0.78)' }} />}
