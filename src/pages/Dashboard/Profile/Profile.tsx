      ...
      <div className="flex w-full max-w-3xl flex-col gap-4">
        ...
        <div style={{
          ...
          <div style={{ padding: "0 28px 28px" }}>
            <div className="mb-6 mt-[-54px] flex flex-col items-center gap-4 sm:flex-row sm:items-end">
            ...
            <InfoRow icon={<PhoneOutlined />} label="Telefon raqami">
              {editing
                ? <input style={inputStyle} value={form.phone} onChange={e => setForm(p => ({ ...p, phone: ensureUzPhonePrefix(e.target.value) }))} placeholder="+998901234567" />
