...
const Users = () => {
    ...
    return (
        <div className="users-page p-5">
            <Caption title="Foydalanuvchilar" count={users.length} icon={<UsergroupAddOutlined />} />
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
                {[
                    ...
                    <div key={stat.label} className="bg-white rounded-xl border border-gray-100 shadow-sm p-4 text-center" >
                        <div className="users-stat-value text-2xl font-bold" style={{ color: stat.color }} >
                            {stat.value}
                        </div>
                        <div className="users-stat-label text-xs mt-1 font-medium">
                            {stat.label}
                        </div>
                    </div>
                ))}
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100" style={{ background: "linear-gradient(135deg, #f5ece3 0%, #fdf8f5 100%)" }}  >
                    ...
                    <div className="text-xs mt-0.5" style={{ color: "#6b5742", fontWeight: 600 }}>
