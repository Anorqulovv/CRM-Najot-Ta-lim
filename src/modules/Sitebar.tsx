...
const ALL_MENU_ITEMS: MenuItem[] = [
  ...
  { key: '10', icon: <HistoryOutlined />, label: 'Faollik', path: PATH.activity, roles: ['SUPERADMIN'] },
  { key: '11', icon: <AuditOutlined />, label: 'Foydalanuvchilar', path: PATH.users, roles: ['SUPERADMIN'] },
  { key: '12', icon: <BarChartOutlined />, label: 'Farzand natijalari', path: PATH.parentResults, roles: ['PARENT'] },
  { key: '13', icon: <UserOutlined />, label: 'Profilim', path: PATH.profile, roles: ['SUPERADMIN', 'ADMIN', 'TEACHER', 'SUPPORT', 'STUDENT', 'PARENT'] },
];
...
const Sitebar: React.FC = () => {
  ...
  return (
    <aside className={`crm-sidebar ${collapse ? 'crm-sidebar-collapsed crm-sidebar-open' : ''}`} style={{
      ...
      <Link to="/" style={{ textDecoration: 'none' }}>
        <div style={{
          ...
          <div className="crm-sidebar-text" style={{ overflow: 'hidden' }}>
            <div style={{
      ...
      {/* Menu label */}
      <div className="crm-sidebar-text" style={{
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="crm-sidebar-text" style={{
      ...
      <div style={{
        ...
        <span className="crm-sidebar-text">© 2026 Najot Ta'lim</span>
        <span className="crm-sidebar-mini">©</span>
      </div>
    </aside>
  );
};
