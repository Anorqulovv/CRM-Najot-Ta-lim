...
const Teachers: FC<TeachersProps> = ({ stackPropId }) => {
  ...
  const { data: teachers = [], isPending } = GetAll(
    QueryPATH.teachers, [debouncedSearch, directionId, branchId], cookies.accessToken, "/teachers",
  ...
  return (
    <div className="p-4 sm:p-5 lg:p-6">
      {/* Page header */}
      <Caption count={teachers.length} title="Ustozlar" icon={<UserOutlined />} />
