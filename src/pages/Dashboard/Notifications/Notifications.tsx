...
const Notifications = () => {
  ...
  const handleSend = async () => {
    ...
    if (recipientType === "specific" && !phone.trim()) {
    ...
    try {
      if (recipientType === "all") {
        await instance(cookies.accessToken).post("/telegram/notify-all", {
          message,
        });

        toast.success("Xabar barcha foydalanuvchilarga yuborildi!");
      } else {
        await instance(cookies.accessToken).post("/telegram/notify-phone", {
          phone: phone.trim(),
          message,
        });
      ...
      setMessage("");
      if (recipientType === "specific") setPhone("+998");
    } catch (err: any) {
  ...
  return (
    <div className="mx-auto max-w-3xl p-4 sm:p-5 lg:p-7">
      <div className="mb-7 flex items-center gap-3">
        ...
        <div>
          ...
          <span style={{ color: "rgba(255,255,255,0.78)", fontSize: 13 }}>
            Foydalanuvchilarga Telegram xabar yuborish
          </span>
        </div>
      </div>
      ...
      <Card
        ...
        bodyStyle={{ padding: 0 }}
      >
        <Space direction="vertical" size={24} className="w-full p-5 sm:p-8">
          <div>
            <label
              style={{
                display: "block",
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                <TeamOutlined
                  style={{
                    fontSize: 22,
                    color: recipientType === "all" ? "#8f5c28" : "#9c8572",
                    marginBottom: 6,
                    display: "block",
                  }}
                />
                <div
                  style={{
                    fontWeight: 600,
                    color: recipientType === "all" ? "#8f5c28" : "#4b5563",
                    fontSize: 13,
                  }}
                >
                  Barcha
                </div>
                <div style={{ fontSize: 11, color: "#9c8572", marginTop: 2 }}>
                  Telegram bog'langanlar
                </div>
              </div>
              ...
              >
                <UserOutlined
                  style={{
                    fontSize: 22,
                    color: recipientType === "specific" ? "#8f5c28" : "#9c8572",
                    marginBottom: 6,
                    display: "block",
                  }}
                />
                <div
                  style={{
                    fontWeight: 600,
                    color: recipientType === "specific" ? "#8f5c28" : "#4b5563",
                    fontSize: 13,
                  }}
                >
                  Aniq foydalanuvchi
          ...
          {recipientType === "all" && (
            ...
            >
              <TeamOutlined />
              <span>
                Xabar Telegram botini bog'lagan <strong>barcha foydalanuvchilarga</strong> yuboriladi
              </span>
            </div>
          )}
          ...
          <div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6 }}>
              <p style={{ fontSize: 12, color: "#9c8572", margin: 0 }}>
                HTML formatlash ishlatiladi: &lt;b&gt;, &lt;i&gt;
              </p>
