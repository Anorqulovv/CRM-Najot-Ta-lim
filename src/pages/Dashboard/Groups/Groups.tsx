...
import { SearchOutlined, CalendarOutlined, CheckCircleOutlined, CloseCircleOutlined, TeamOutlined, SaveOutlined, UserOutlined, BarChartOutlined } from "@ant-design/icons"
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div className="mb-5 flex flex-col gap-3 md:flex-row md:flex-wrap md:items-center">
        <Input
          ...
          className="w-full max-w-full rounded-xl border-[#e5d8cc] bg-white text-[13.5px] md:max-w-[280px]"
        />
        {filters}
